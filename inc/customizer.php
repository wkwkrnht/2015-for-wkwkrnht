<?php function twentyfifteen_customize_register($wp_customize){
...
function twentyfifteen_get_color_schemes(){
	...
	return apply_filters('twentyfifteen_color_schemes',array(
		...
		/*'名前' => array(
			...
			'colors' => array('背景色','サイドバー背景色','ボックス背景色','通常文字色','サイドバー文字色','メタボックス背景色',),),*/
	) );
}
...
function twentyfifteen_get_color_scheme_css($colors){
	...
	.post-navigation,.pagination,.secondary,.site-footer,
	.hentry,.page-header,.page-content,.comments-area,.widecolumn{background-color: {$colors['box_background_color']};}

	/* Box Background Color */
	input[type="button"],input[type="reset"],input[type="submit"],
	.pagination .prev,.pagination .next,
	.widget_calendar tbody a,.widget_calendar tbody a:hover,.widget_calendar tbody a:focus,
	.page-links a,.page-links a:hover,.page-links a:focus,
	button,.sticky-post{color: {$colors['box_background_color']};}
	...
	.pingback .edit-link a:hover,
	.comment-list .reply a:hover,
	.site-info a:hover{border-color: {$colors['textcolor']};}
	...
	/* Secondary Text Color */
	blockquote,.logged-in-as a:hover,.comment-author a:hover{
		border-color: {$colors['textcolor']}; /* Fallback for IE7 and IE8 */
		border-color: {$colors['secondary_textcolor']};
	}

	/* Border Color */
	hr,.dropdown-toggle:hover,.dropdown-toggle:focus{
		background-color: {$colors['textcolor']}; /* Fallback for IE7 and IE8 */
	...
	.page-links > span,
	.comment-navigation,.comments-area,
	...
	@media screen and (min-width: 38.75em){/* Main Text Color */.page-header{border-color: {$colors['textcolor']};}}
	@media screen and (min-width: 59.6875em){
		/* Make sure its transparent on desktop */
		.site-header,.secondary{background-color:transparent;}
		...
		.widget .gallery-caption{color: {$colors['secondary_sidebar_textcolor']};}
		.widget button:hover,
		.widget button:focus,
		...
		.widget_calendar tbody a:focus{background-color: {$colors['secondary_sidebar_textcolor']};}
		...
		.widget abbr[title]{border-color: {$colors['sidebar_border_color']};}
