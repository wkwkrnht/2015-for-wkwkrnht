...
*/
function sat_enqueue_assets(){if(is_single()){wp_enqueue_style('select-and-tweet',plugins_url('/select-and-tweet.css', __FILE__ ));wp_enqueue_script('select-and-tweet',plugins_url('/select-and-tweet.js', __FILE__ ), array('jquery'),'1.0',true );}}
