...
function url_to_googleplaycard($atts){extract(shortcode_atts(array('url'=>'',),$atts));$deta=json_safe_encode($url);$content='<script id="script" src="google_play_card.js" data-url=' . $deta . '></script>';return $content;}
