...
function url_to_googleplaycard($atts){extract(shortcode_atts(array('url'=>'',),$atts));$content='<script id="script" src="google_play_card.js" data-url="' . $url . '"></script>';return $content;}
