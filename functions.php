...
function url_to_googleplaycard($atts){extract(shortcode_atts(array('url'=>'',),$atts));$content='<script src="google_play_card.js"></script><div id="googleplay-card" data-url="' . $url . '"></div>';return $content;}
