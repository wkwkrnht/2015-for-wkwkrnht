<section class="no-results not-found">
	<header class="page-header"><h1 class="page-title"><?php _e('Nothing Found','twentyfifteen' );?></h1></header>
	<div class="page-content">
		<?php if(is_home()&&current_user_can('publish_posts')):?>
			<p><?php printf(__('<a href="%1$s">Ready to publish your first post? Get started here</a>.','twentyfifteen'),esc_url(admin_url('post-new.php')));?></p>
