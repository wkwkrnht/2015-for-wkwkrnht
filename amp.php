...
<body>
	...
	<article>
		<header>
			<?php echo preg_replace(array('/<img/i','i/\/>/'),array('<amp-img layout="responsive"','><amp-img>'),the_post_thumbnail());?>
