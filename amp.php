...
<head>
	...
	<style amp-custom>
		.bread{color:#ddd;}.bread .sp{color:#333;margin:0 .5em;}a{color:#1122cc;}
		h2,h3,h4{min-height:45px;text-align:center;}h2{color:#fff;background:#ffcc00;}h3{border-left:10px solid #ffcc00;background-color:#fff;}h4{border-bottom:8px solid #ffcc00;background-color:#fff;}
	</style>
