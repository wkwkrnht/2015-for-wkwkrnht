...
<div class="snsshare">
  ...
  <div class="content">
	...
	<a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink();?>&media=<?php echo wp_get_attachment_url(get_post_thumbnail_id($post->ID));?>&description=<?php echo str_replace(array("<p>","</p>"),"",get_the_excerpt());?>" target="_blank"><div class="printerest button"></div></a>
