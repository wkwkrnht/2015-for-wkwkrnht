    ...
    <div class="content">
      <?php while($query->have_posts()):$query->the_post();?>
        <a href="<?php the_permalink()?>" title="<?php the_title_attribute();?>"><div class="related">
          <?php if(has_post_thumbnail()):echo get_the_post_thumbnail($post->ID,'related',array('class'=>'thumb'));else:echo'<img src="' . home_url() . '/wp-content/themes/2015-for-wkwkrnht/img/no-img.png" class="thumb" alt="no_thumbnail" width="150px" height="150px"/>';endif;
