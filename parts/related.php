...
$img=$image
if(has_post_thumbnail()):$image=array(echo'get_the_post_thumbnail($post->ID)');else:$image=array(echo'get_stylesheet_directory_uri()./img/no-img.png');endif;
  if($query -> have_posts()):
   while($query -> have_posts()):$query->the_post();?>
    <div class="swiper-slide"><div class="content"><a href="<?php the_permalink()?>" title="<?php the_title_attribute();?>">
      <div class="thumb" style="background-image=url("<?php echo($img)?>")"></div>
