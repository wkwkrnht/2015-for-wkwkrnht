<div class="snsshare">
  <div class="content">
    ...
    <a href="http://line.me/R/msg/text/?<?php the_title(); ?>%0D%0A<?php the_permalink();?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri();?>/img/line.svg" alt="LINEで送る" width="50px" height="50px" class="line button"/></a>
  ...
  <div class="content">
	...
	<a href="http://embed.ly/code" data-url="<?php the_permalink(); ?>"><img src="<?php echo get_stylesheet_directory_uri();?>/img/embed.png" alt="embedly" width="50px" height="50px" class="embedly button"></img></a><script>!function(a){var b="embedly-platform",c="script";if(!a.getElementById(b)){var d=a.createElement(c);d.id=b,d.src=("https:"===document.location.protocol?"https":"http")+"://cdn.embedly.com/widgets/platform.js";var e=document.getElementsByTagName(c)[0];e.parentNode.insertBefore(d,e)}}(document);</script>
