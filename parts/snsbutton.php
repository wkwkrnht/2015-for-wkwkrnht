...
<div class="snsbutton">
  ...
  <a class="pocket" href="http://getpocket.com/edit?url=<?php echo home_url();?>&amp;title=<?php bloginfo('name');?>" onclick="window.open(this.href,'FBwindow','width=550,height=350,menubar=no,toolbar=no,scrollbars=yes');return false;">\f224</a>
