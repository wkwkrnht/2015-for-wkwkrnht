<div class="snsshare">
  <div class="content">
    ...
    <a href="http://line.me/R/msg/text/?<?php the_title(); ?>%0D%0A<?php the_permalink();?>" target="_blank"><div class="line button"><img src="<?php echo get_stylesheet_directory_uri();?>/img/line.svg" alt="LINEで送る" width="50px" height="50px"/></div></a>
    <a href="http://b.hatena.ne.jp/add?mode=confirm&url=<?php echo get_permalink();?>&amp;title=<?php echo trim(wp_title('',false));?>" target="_blank"><div class="hatebu button"><img src="<?php echo get_stylesheet_directory_uri();?>/img/hatebu.svg" alt="hatebu"/></div></a>
  ...
  <div class="content">
	...
	<a href="http://cdn.embedly.com/widgets/embed?url=<?php the_permalink();?>" onclick="window.open(this.href,'window','width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1');return false;"><div class="embedly button"><img src="<?php echo get_stylesheet_directory_uri();?>/img/embed.png" alt="embedly" width="50px" height="50px"></img></div></a><script>!function(a){var b="embedly-platform",c="script";if(!a.getElementById(b)){var d=a.createElement(c);d.id=b,d.src=("https:"===document.location.protocol?"https":"http")+"://cdn.embedly.com/widgets/platform.js";var e=document.getElementsByTagName(c)[0];e.parentNode.insertBefore(d,e)}}(document);</script>
