<div id="snsshare" class="content">
  ...
  <div>
    ...
    <a href="https://push.dog/subscribe?url=<?php echo esc_url(home_url())?>" onclick="window.open(this.href,'window','width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1');return false;"><div class="pushdog button"><div/></a>
  </div>
</div>