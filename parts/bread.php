<?php if(!is_home()&&!is_front_page()):
  ...
  if($cat && !is_wp_error($cat)){$par = get_category($cat[0]->parent);
      echo'<div class="bread"><div itemtype="http://data-vocabulary.org/Breadcrumb" itemscope=""><a href="'.home_url().'" itemprop="url"><span itemprop="title">Home</span></a><span class="sp">/</span></div>';
