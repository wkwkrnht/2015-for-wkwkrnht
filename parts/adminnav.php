<nav id="admin-navigation" class="admin-navigation" role="navigation">
	...
	<?php else:?>
		...
		<?php if(is_home()):edit_post_link();echo'<a href="wlw://wkwkrnht.gegahost.net/?postid=';echo the_ID();echo'" class="wlwedit">WLWで編集</a>';else:echo'<a href="wlw://wkwkrnht.gegahost.net/?postid=';echo the_ID();echo'"></a>';endif;?>
