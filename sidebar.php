<section id="secondary" class="secondary">
	<?php if(is_adminnav_dsp()):?>
		<nav id="admin-navigation" class="admin-navigation" role="navigation">
			...
			<?php else:?>
				<a href="<?php echo esc_url(home_url());?>/wp-admin/post-new.php" target="_blank" class="postnewbutton"></a><?php edit_post_link();?><a href="wlw://wkwkrnht.gegahost.net/?postid=<?php echo the_ID();?>" class="wlwedit"></a><a href="<?php echo esc_url(home_url());?>/wp-admin/" target="_blank" class="adminmenubutton"></a>
			<?php endif;?>
		</nav>
	<?php endif;?>
